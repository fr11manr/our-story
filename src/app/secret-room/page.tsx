    ...
    <SiteShell>
      <PageTransition>
        ...
        <div className="mt-10 grid gap-5 lg:grid-cols-3">
          {["Future Plans", "Private Promises", "Surprise Ideas"].map((title) => (
            <article key={title} className="rounded-[32px] border border-white/10 bg-white/[0.07] p-7 backdrop-blur-xl">
